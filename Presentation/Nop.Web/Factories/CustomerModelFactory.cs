...
namespace Nop.Web.Factories
{
    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
            ...
            string overrideCustomCustomerAttributesXml = "", bool setDefaultValues = false)
        {
            ...
            await _baseAdminModelFactory.PrepareSongCountAsync(model.PackageModel.AvailableSongCounts, true);

            //prepare available delivery days
            await _baseAdminModelFactory.PrepareDeliveryDaysAsync(model.PackageModel.AvailableDeliveryDays, true);
