...
namespace Nop.Web.Controllers
{
    ...
    public partial class CustomerController : BasePublicController
    {
        ...
        async Task HandleFailedLoginAsync(string userNameOrEmail)
        {
            ...
            if (customer == null || await _customerService.IsAdminAsync(customer))
            {
            ...
            if (customer.FailedLoginAttempts >= 4)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    if (model.IsDJ)
                    {
                        ...
                        await _packageService.InsertPackageAsync(basicPackage);
                        ...
                        await _packageService.InsertPackageAsync(standardPackage);
                    ...
                    {
                        if (model.Event != null && model.Event > 0)
                            customer.EventHostCount = model.Event;

                        if (model.CategoryId != null && model.CategoryId > 0)
                            customer.GenreId = model.CategoryId;
                    }
        ...
        protected virtual async Task SaveVendorCategoryMappingsAsync(Vendor vendor, RegisterModel model)
        {
