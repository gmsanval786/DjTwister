...
namespace Nop.Services.Catalog
{
    ...
    public partial interface ICategoryService
    {
        ...
        /// </returns>
        Task<IList<VendorCategory>> GetVendorCategoriesByVendorIdAsync(int vendorId, bool showHidden = false);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteVendorCategoryAsync(VendorCategory vendorCategory);
        ...
        /// <param name="categoryId">Category identifier</param>
        /// <returns>A ProductCategory that has the specified values; otherwise null</returns>
        VendorCategory FindVendorCategory(IList<VendorCategory> source, int vendorId, int categoryId);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertVendorCategoryAsync(VendorCategory vendorCategory);
    }
}