...
namespace Nop.Services.Catalog
{
    ...
    public static partial class NopCatalogDefaults
    {
        ...
        /// {3} : store ID
        /// </remarks>
        public static CacheKey VendorCategoriesByVendorCacheKey => new("Nop.vendorcategory.byvendor.{0}-{1}-{2}-{3}", VendorCategoriesByVendorPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string VendorCategoriesByVendorPrefix => "Nop.vendorcategory.byvendor.{0}";
